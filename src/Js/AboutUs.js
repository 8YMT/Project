...
function AboutUs() {
  ...
  return (
    ...
    >
      ...
      >
        <p className="minor">For [Company Name], interior design is more than a craft<br/>—it’s a commitment to excellence. With [Number of <br/>years] of dedicated practice, we have mastered the art of<br/> creating spaces that resonate with elegance and<br/> purpose.<br/>
              ...
              At [Company Name], we don't just design interiors; we<br/> create experiences—spaces where every element tells a story, and every piece finds its place.</p>
      </motion.div>
    </div>
  );
}
